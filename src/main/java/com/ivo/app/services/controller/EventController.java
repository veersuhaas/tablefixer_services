...
public class EventController {
    ...
    public ResponseEntity<EventDetailRequest> createEvent(@RequestBody @Valid EventDetailRequest event, @PathVariable(value = "userUUID") String userUUID)  {
    ...
    public ResponseEntity<EventDetailRequest> updateEvent(@RequestBody @Valid UpdateEventRequest event, @PathVariable(value = "userUUID") String userUUID)  {
